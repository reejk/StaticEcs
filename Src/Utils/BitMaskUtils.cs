...
namespace FFS.Libraries.StaticEcs {
    ...
    #endif
    internal static class BitMaskUtils {
    ...
    [Il2CppSetOption(Option.ArrayBoundsChecks, false)]
    #endif
    internal static class BitMaskUtils<WorldID, CompType> where WorldID : struct, IWorldId {
        private static ulong[] _bitMap;
        internal static ushort _len;
        internal static ulong[] _buffer;
        private static byte _freeCount;
        private static byte _borrowed;
        private static byte _size;

        [MethodImpl(AggressiveInlining)]
        internal static void Create(ulong[] bitMap, byte size, ushort maskLen) {
            _bitMap = bitMap;
            _size = size;
            _len = maskLen;
        ...
        [MethodImpl(AggressiveInlining)]
        internal static void SetNewBitMap(ulong[] bitMap) {
            _bitMap = bitMap;
        }

        [MethodImpl(AggressiveInlining)]
        internal static void ResizeBuffer(ushort maskLen) {
        ...
        [MethodImpl(AggressiveInlining)]
        internal static byte BorrowBuf() {
        ...
        [MethodImpl(AggressiveInlining)]
        internal static void DropBuf(byte id) {
            _borrowed--;
            if (_borrowed == 0) {
                _freeCount = _size;
            }
        ...
        [MethodImpl(AggressiveInlining)]
        public static void Set(int bitMapIdx, ushort bitPos) {
        ...
        [MethodImpl(AggressiveInlining)]
        public static void SetInBuffer(byte bufId, ushort bitPos) {
            var div = (ushort) (bitPos >> 6);
            var rem = (ushort) (bitPos & 63);
        ...
        [MethodImpl(AggressiveInlining)]
        public static void DelInBuffer(byte bufId, ushort bitPos) {
            var div = (ushort) (bitPos >> 6);
            var rem = (ushort) (bitPos & 63);
            var index = bufId * _len + div;
            _buffer[index] &= ~(1UL << rem);
        ...
        [MethodImpl(AggressiveInlining)]
        public static bool Has(int bitMapIdx, ushort bitPos) {
            var div = (ushort) (bitPos >> 6);
            var rem = (ushort) (bitPos & 63);
            var index = bitMapIdx * _len + div;
        ...
        [MethodImpl(AggressiveInlining)]
        public static bool HasInBuffer(byte bufId, ushort bitPos) {
            var div = (ushort) (bitPos >> 6);
            var rem = (ushort) (bitPos & 63);
            var index = bufId * _len + div;
        ...
        [MethodImpl(AggressiveInlining)]
        public static bool IsEmpty(int bitMapIdx) {
        ...
        [MethodImpl(AggressiveInlining)]
        public static bool IsEmptyBuffer(byte bufId) {
        ...
        [MethodImpl(AggressiveInlining)]
        public static ushort Len(int bitMapIdx) {
            ushort count = 0;
        ...
        [MethodImpl(AggressiveInlining)]
        public static ushort LenBuffer(byte bufId) {
            ushort count = 0;
        ...
        [MethodImpl(AggressiveInlining)]
        public static int GetMinIndex(int bitMapIdx) {
            var offset = bitMapIdx * _len;
            for (var i = 0; i < _len; i++, offset++) {
                var v = _bitMap[offset];
                if (v != 0UL) {
                    return (i << 6) + BitMaskUtils.BitsLut[((ulong) ((long) v & -(long) v) * 0x37E84A99DAE458F) >> 58];
                }
            }
        ...
        [MethodImpl(AggressiveInlining)]
        public static int GetMinIndexBuffer(byte BufId) {
            var offset = BufId * _len;
            for (var i = 0; i < _len; i++, offset++) {
                var v = _buffer[offset];
                if (v != 0UL) {
        ...
        [MethodImpl(AggressiveInlining)]
        public static void ClearAll(int bitMapIdx) {
        ...
        [MethodImpl(AggressiveInlining)]
        public static void ClearAllInBuffer(byte BufId) {
        ...
        [MethodImpl(AggressiveInlining)]
        public static bool HasAll(int bitMapIdx, byte bufId) {
            var srcOffset = bitMapIdx * _len;
        ...
        [MethodImpl(AggressiveInlining)]
        public static bool HasAny(int bitMapIdx, byte bufId) {
            var srcOffset = bitMapIdx * _len;
            var srcOffsetEnd = srcOffset + _len;
            var bufOffset = bufId * _len;
            for (; srcOffset < srcOffsetEnd; srcOffset++, bufOffset++) {
        ...
        [MethodImpl(AggressiveInlining)]
        public static bool HasAllAndExc(int bitMapIdx, byte bufIdAll, byte bufIdExc) {
            var srcOffset = bitMapIdx * _len;
            var srcOffsetEnd = srcOffset + _len;
        ...
        [MethodImpl(AggressiveInlining)]
        public static bool NotHasAny(int bitMapIdx, byte bufId) {
            var srcOffset = bitMapIdx * _len;
            var srcOffsetEnd = srcOffset + _len;
            var bufOffset = bufId * _len;
            for (; srcOffset < srcOffsetEnd; srcOffset++, bufOffset++) {
